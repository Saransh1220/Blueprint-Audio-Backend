...
type Client struct {
	...
	// UserID associated with this connection (optional, for targeted notifications)
	userID uuid.UUID
}
...
func (c *Client) readPump() {
	...
	for {
		...
		// We ignore incoming messages for now, this is a push-only system for notifications
	}
}
